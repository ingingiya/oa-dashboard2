                    ...
                    <div key={key} style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                      ...
                      {settleForm[key] ? (
                        <div style={{flex:1,display:"flex",alignItems:"center",gap:6}}>
                          ...
                          <a href={settleForm[key]+(settleForm[key].includes('?')?'&':'?')+'download='+encodeURIComponent((settleModal.account||settleModal.name||"inf")+"_"+label+"."+(settleForm[key].split('.').pop().split('?')[0]||"jpg"))} style={{fontSize:10,color:"#2563eb",fontWeight:700,textDecoration:"none",padding:"2px 7px",border:"1px solid #2563eb",borderRadius:5}}>다운로드</a>
